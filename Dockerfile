...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.label-schema.description="An up-to-date Linux Mint image with basic build tools" \
      org.label-schema.url="https://www.linuxmint.com/" \
      org.label-schema.vcs-ref=$VCS_REF \
      org.label-schema.vcs-url="https://github.com/vcatechnology/docker-linux-mint-ci" \
